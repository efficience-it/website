...
export const metadata = pageMetadata({
  title: "Montez en compétences et structurez vos projets Symfony",
  description:
...
const webPage = webPageJsonLd({
  name: "Montez en compétences et structurez vos projets Symfony",
  description:
    "Efficience IT accompagne les équipes sur l'organisation, le conseil, le coaching et la formation autour de Symfony et des projets web professionnels.",
  path: "/accompagnement-et-conseil",
          ...
          <div className="grid items-center gap-12 md:grid-cols-2">
            <div>
              <h1 className="font-display text-4xl font-bold text-dark md:text-5xl">
                Montez en compétences et structurez vos projets Symfony
              </h1>
