...
const faqItems = [
  ...
  },
  {
    ...
    content:
      "Notre spécialisation exclusive sur Symfony et PHP nous distingue des agences généralistes parisiennes. Vous bénéficiez d'une expertise technique pointue, avec la réactivité d'une équipe dédiée et une proximité renforcée par notre présence en région.",
  },
  {
            ...
            <Container>
              ...
              <div className="mt-10 grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
                ...
                <Card>
                  ...
                  <p className="mt-2 text-gray">
                    Basés en région, nous combinons expertise technique pointue et
                    disponibilité accrue. Vous bénéficiez du même niveau
                    d&apos;exigence qu&apos;une agence parisienne, avec une réactivité
                    renforcée.
                  </p>
                </Card>
              </div>
              ...
              <div className="grid items-center gap-12 md:grid-cols-2">
                ...
                <div className="grid gap-4">
                  ...
                  <div className="rounded-lg border border-gray-100 bg-white p-6 shadow-sm">
                    ...
                    <p className="mt-1 text-gray">
                      De Lille en TGV : la proximité en toute simplicité
                    </p>
                  </div>
                </div>
              </div>
