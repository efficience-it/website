...
export const STATIC_SILOS: RouteSilo[] = [
  {
    ...
    routes: [
      ...
      { path: "/nos-references", label: "Nos références", lastModified: "2026-06-18", changeFrequency: "monthly", priority: 0.7 },
  ...
  },
  {
    ...
    routes: [
      ...
      { path: "/developpement-web-sur-mesure", label: "Développement web sur mesure", lastModified: "2026-06-18", changeFrequency: "monthly", priority: 0.8 },
      ...
      { path: "/developpement-php", label: "Développement PHP", lastModified: "2026-06-18", changeFrequency: "monthly", priority: 0.8 },
      { path: "/developpement-nodejs", label: "Développement Node.js", lastModified: "2026-03-11", changeFrequency: "monthly", priority: 0.8 },
      { path: "/developpement-frontend", label: "Développement frontend", lastModified: "2026-06-18", changeFrequency: "monthly", priority: 0.8 },
      { path: "/developpement-react", label: "Développement React", lastModified: "2026-06-18", changeFrequency: "monthly", priority: 0.8 },
      { path: "/developpement-vuejs", label: "Développement Vue.js", lastModified: "2026-06-18", changeFrequency: "monthly", priority: 0.8 },
      { path: "/developpement-typescript", label: "Développement TypeScript", lastModified: "2026-06-18", changeFrequency: "monthly", priority: 0.8 },
      ...
      { path: "/audit-ia-entreprise", label: "Audit IA en entreprise", lastModified: "2026-09-03", changeFrequency: "monthly", priority: 0.8 },
      { path: "/geo-optimisation-ia", label: "Optimisation géographique IA", lastModified: "2026-03-12", changeFrequency: "monthly", priority: 0.8 },
      { path: "/ecommerce-sylius", label: "E-commerce Sylius", lastModified: "2026-06-18", changeFrequency: "monthly", priority: 0.8 },
      ...
      { path: "/integration-elasticsearch-symfony", label: "Intégration Elasticsearch Symfony", lastModified: "2026-06-18", changeFrequency: "monthly", priority: 0.8 },
    ],
  },
  {
    id: "villes",
  ...
  },
  {
    ...
    routes: [
      { path: "/secteur", label: "Tous les secteurs", lastModified: "2026-06-18", changeFrequency: "monthly", priority: 0.7 },
      { path: "/secteur/e-commerce", label: "E-commerce", lastModified: "2026-06-18", changeFrequency: "monthly", priority: 0.7 },
      { path: "/secteur/finance", label: "Finance", lastModified: "2026-06-18", changeFrequency: "monthly", priority: 0.7 },
      { path: "/secteur/industrie", label: "Industrie", lastModified: "2026-06-18", changeFrequency: "monthly", priority: 0.7 },
      { path: "/secteur/saas", label: "SaaS", lastModified: "2026-06-18", changeFrequency: "monthly", priority: 0.7 },
      { path: "/secteur/migration-legacy", label: "Migration legacy", lastModified: "2026-06-18", changeFrequency: "monthly", priority: 0.7 },
      { path: "/secteur/renfort-equipe", label: "Renfort d'équipe", lastModified: "2026-03-30", changeFrequency: "monthly", priority: 0.7 },
      { path: "/secteur/application-metier", label: "Application métier", lastModified: "2026-09-03", changeFrequency: "monthly", priority: 0.7 },
      { path: "/secteur/maintenance-applicative", label: "Maintenance applicative", lastModified: "2026-06-18", changeFrequency: "monthly", priority: 0.7 },
      { path: "/secteur/api-integration", label: "API et intégration", lastModified: "2026-06-18", changeFrequency: "monthly", priority: 0.7 },
