...
type ResearchIllustrationProps = React.SVGProps<SVGSVGElement>;

/**
 * Illustration : Research / Study (by Katerina Limpitsouni - undraw.co)
 * Supporte Tailwind CSS via className et toutes les props SVG standards via {...props}.
 */
const ResearchIllustration = (props: ResearchIllustrationProps) => (
    <svg
    ...
    {...props}
  >
    <style>{`.dark .research-right-links{fill:#fff}.dark .research-ground-line{fill:#090814}`}</style>
    <g transform="translate(-526.81 -263.328)">
      ...
      />
      <path
        d="M507.591,240.989a5.076,5.076,0,0,0-2.07.92,7.058,7.058,0,0,0-1.672,1.772,8.805,8.805,0,0,0-1.11,2.373,9.189,9.189,0,0,0-.386,2.729V607.174a9.525,9.525,0,0,0,1.5,5.192,7.712,7.712,0,0,0,1.672,1.873,5.437,5.437,0,0,0,2.07,1.044L767.1,673.154a7.926,7.926,0,0,0,3.342,0,6.427,6.427,0,0,0,4.54-3.727,7.821,7.821,0,0,0,.635-3.285v-459.9a8.092,8.092,0,0,0-.635-3.323,6.983,6.983,0,0,0-4.54-4,7.969,7.969,0,0,0-3.342-.2Z"
      ...
      <g transform="translate(1121.847 406.71)">
        <path
          ...
          className="research-right-links"
        />
        <path
      ...
      <g transform="translate(526.81 479.266)">
        <g transform="translate(0 0)">
          ...
          />
          <path
            d="M89.68,203.788l46.052,86.07,18.007-9.631L113.4,192.033"
          ...
          />
          <path
            d="M90.88,166.988l-23.535-5.725L52.26,180.579A31.1,31.1,0,0,0,50.681,204.1L63.19,241.633s38.165-.637,46.434-22.9l2.371-4.939a20.323,20.323,0,0,0-1.911-20.782Z"
        ...
        <g transform="matrix(-0.766, -0.643, 0.643, -0.766, 158.754, 187.688)">
          <path
      ...
      <g transform="translate(698.508 586.962)">
        <path
