...
type ProgrammingIllustrationProps = React.SVGProps<SVGSVGElement>;

/**
 * Illustration : Programming (by Katerina Limpitsouni - undraw.co)
 * Ce composant accepte toutes les props standards d'un SVG (className, width, height, onClick, etc.)
 */
const ProgrammingIllustration = (props: ProgrammingIllustrationProps) => (
  <svg
  ...
  >
    <g transform="translate(-28.583 -435)">
      ...
      <path
        ...
        fill="#3f3d56"
      />
      <circle cx={121.89} cy={1083.321} r={6.815} fill="#3f3d56" />
      <circle cx={145.434} cy={1083.321} r={6.815} fill="#3f3d56" />
      <circle cx={168.978} cy={1083.321} r={6.815} fill="#3f3d56" />
      <path
      ...
      <g transform="translate(250.837 684.649)">
        ...
        <path
          ...
          fill="#090814"
        />
        <circle cx={156.947} cy={76.312} r={51.737} fill="#ed9da0" />
        <path
      ...
      <g transform="translate(152.761 713.325)">
        <rect width={84.14} height={13.744} rx={6.872} transform="translate(22.907 0)" fill="#FEDA5E" />
        <rect width={146.6} height={13.744} rx={6.872} transform="translate(0 32.07)" fill="#e6e6e6" />
        <rect width={146.6} height={13.744} rx={6.872} transform="translate(0 64.141)" fill="#e6e6e6" />
      </g>
    </g>
  </svg>
);

export default ProgrammingIllustration;