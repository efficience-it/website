  ...
  return (
    <div className="ml-4 flex items-center gap-2">
      <TrackedHeaderLink
        ...
        className="group inline-flex items-center gap-2 rounded-lg border border-border bg-white px-4 py-2 text-sm font-medium text-dark shadow-sm transition-all duration-200 hover:border-primary/30 hover:shadow-md"
