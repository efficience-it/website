...
function makePost(overrides: Partial<BlogPost>): BlogPost {
  return {
    ...
    kind: "blog",
    excerpt: "Excerpt",
    image: "/images/blog/post-test.webp",
    content: "Contenu",
    wordCount: 1200,
    ...overrides,
  };
  ...
  it("includes only news posts published within 48 hours", async () => {
    ...
    mockedGetAllPosts.mockReturnValue([
      makePost({
        ...
        kind: "news",
        date: "2026-05-05T10:00:00.000Z",
        image: "/images/blog/news-recent.webp",
      }),
      makePost({
        slug: "news-old",
        title: "News ancienne",
    ...
    expect(xml).toContain(
      "<news:image><news:loc>https://www.itefficience.com/images/blog/news-recent.webp</news:loc></news:image>",
    );
