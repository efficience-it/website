...
export const services = [
  ...
  },
  {
    ...
    description:
      "Nous accompagnons les PME et grandes entreprises dans la modernisation et l'optimisation de leurs infrastructures IT.",
    items: [
      "Hébergement cloud (AWS, Azure, GCP, OVH)",
  ...
  },
  {
    ...
    items: [
      ...
      "Audits IT (sécurité, performance, code)",
      "Formation Symfony et méthodes agiles",
    ],
  },
];
