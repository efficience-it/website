...
- [Conventions de codage : bonnes pratiques pour un code maintenable](/article/coding-conventions), structurer le code et la documentation avec des règles d'équipe partagées
