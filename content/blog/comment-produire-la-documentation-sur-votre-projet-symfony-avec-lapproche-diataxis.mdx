...
Stocker la documentation dans le même dépôt que le code (approche docs-as-code) permet de lier les modifications de documentation aux pull requests qui modifient le comportement. Ce principe rejoint celui des [conventions de codage](/article/coding-conventions) : un contrat technique versionné, partagé et maintenu par toute l'équipe. Un template de PR qui inclut une section "documentation impactée" rend le réflexe systématique.
