...
[PHPStan](/article/comment-phpstan-peut-vous-aider-a-ameliorer-la-qualite-de-votre-code-php) et Psalm ne vérifient pas le formatage : ils analysent la sémantique du code. Types incorrects, appels à des méthodes inexistantes, variables potentiellement nulles, branches mortes. À des niveaux élevés (PHPStan niveau 8, 9 ou 10), ils imposent une rigueur de typage comparable à celle des langages compilés, ou à celle de [TypeScript côté JavaScript](/developpement-typescript).
