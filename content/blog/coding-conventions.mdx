...
L'enjeu pour un architecte est de maintenir des conventions vivantes : régulièrement révisées, automatiquement appliquées, et comprises par tous. Un [état des lieux PHP](/audit-code-php) peut servir de point de départ pour formaliser ces conventions et mesurer l'écart entre l'existant et les standards visés. Des outils comme [Rector permettent d'appliquer les conventions automatiquement sur le code existant](/article/rector-et-ses-pouvoirs-maitrisez-levolution-de-votre-code-symfony), y compris lors des migrations de version. Un rituel trimestriel de revue des conventions, combiné à un outillage solide, garantit que les standards restent pertinents sans devenir un carcan.
