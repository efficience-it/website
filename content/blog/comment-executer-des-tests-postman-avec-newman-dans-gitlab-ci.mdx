...
La gestion des variables d'environnement est le premier point où la configuration devient intéressante. Comme pour la [gestion des secrets dans un projet Symfony](/article/dbtoolsbundle-anonymiser-vos-bases-de-donnees), une stratégie sécurisée combine trois niveaux.
