...
- [PHPStan au niveau max sur un projet Symfony](/article/phpstan-niveau-max-symfony-10-erreurs), valider les contraintes d'architecture par l'analyse statique
