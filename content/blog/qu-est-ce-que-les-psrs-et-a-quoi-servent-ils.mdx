...
- [Conventions de codage](/article/coding-conventions) — Les conventions de codage pour un code propre et maintenable
- [PHPStan : améliorer la qualité de votre code PHP](/article/comment-phpstan-ameliorer-qualite-code-php) — L'analyse statique au service de la qualité
...
- [PHP-FIG sur GitHub](https://github.com/php-fig) — Les dépôts officiels des interfaces PSR
