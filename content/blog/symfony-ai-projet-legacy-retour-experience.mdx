...
[Symfony AI](https://symfony.com/doc/current/ai.html) est un bon outil. L'abstraction fournisseur fonctionne. Le support du streaming est solide. Mais le composant ne résout pas les vrais problèmes : la gestion des erreurs, le coût, la qualité des prompts, et la cohabitation avec du code qui n'a pas été pensé pour.
...
- [Symfony AI : annonce officielle](https://symfony.com/doc/current/ai.html), présentation du composant
