...
- [INT, UUID ou ULID : quel identifiant choisir](/article/prendre-int-uuid-ou-ulid-pour-un-index-de-base-de-donnees), concevoir des identifiants robustes pour vos ressources REST
