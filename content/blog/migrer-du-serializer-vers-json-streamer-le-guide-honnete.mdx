...
- [Migration Symfony vers l'architecture hexagonale](/article/migration-symfony-architecture-hexagonale-retour-mission), comprendre le contexte où les DTOs purs émergent naturellement
...
- [Doctrine ORM 3.0](/article/doctrine-orm-3-0-une-nouvelle-version-majeure-pour-les-bases-de-donnees), les changements côté persistance qui accompagnent cette migration
