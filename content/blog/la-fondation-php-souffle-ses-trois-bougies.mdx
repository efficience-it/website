...
- **Facebook**, qui a initialement construit sa plateforme avec PHP avant de migrer vers Hack, un langage dérivé de PHP qui tourne sur HHVM (Hip Hop Virtual Machine).
