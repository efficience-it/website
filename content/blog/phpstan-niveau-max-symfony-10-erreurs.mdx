---
title: "PHPStan niveau max sur un projet Symfony : les 10 erreurs que vous allez trouver"
date: "2026-03-09"
updatedAt: "2026-03-26"
author: "Louis-Arnaud Catoire"
category: "Qualité de code"
excerpt: "Passer PHPStan au niveau 10 sur un projet Symfony révèle des dizaines d'erreurs. Les 10 plus fréquentes et comment les corriger proprement."
image: "/images/blog/phpstan-symfony.webp"
...
Sur un projet de taille moyenne, comptez entre 50 et 200 occurrences. Un bon regex dans votre IDE règle ça en une heure. Les évolutions de [Doctrine ORM 3.0](/article/doctrine-orm-3-0-une-nouvelle-version-majeure-pour-les-bases-de-donnees) améliorent d'ailleurs le typage natif des collections.
...
Ne faites jamais de `assert($user !== null)` sauf dans les tests. C'est un pansement qui masque un vrai problème de gestion d'erreur. Respecter les [bonnes pratiques des API REST](/article/api-rest-les-bonnes-pratiques) impose de gérer proprement ces cas de retour `null`.
...
C'est la méthode recommandée depuis Symfony 6.2. Elle élimine l'erreur PHPStan et rend votre code plus testable. Pour en savoir plus sur la configuration du [conteneur de services Symfony](https://symfony.com/doc/current/service_container.html), la documentation officielle détaille toutes les options d'injection.
...
PHPStan fait confiance au `@return` déclaré. Ça résout l'erreur et ça documente le contrat de votre méthode. L'extension [phpstan/phpstan-doctrine](https://github.com/phpstan/phpstan-doctrine) améliore aussi la compréhension des types DQL.
...
Vérifiez que vos méthodes de listener acceptent exactement le type d'événement dispatché. L'extension [phpstan/phpstan-symfony](https://github.com/phpstan/phpstan-symfony) connaît les types d'événements du kernel et valide les signatures automatiquement.
