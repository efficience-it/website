...
Tu viens de monter [PHPStan](https://phpstan.org/) au niveau 10 sur ton projet Symfony. Le terminal affiche 847 erreurs. Tu refermes le couvercle de ton laptop et tu te demandes si c'était une bonne idée.
...
[Doctrine](https://www.doctrine-project.org/) utilise l'interface `Collection` qui est générique. PHPStan au niveau 10 exige que tu précises le type de la clé et de la valeur. Sans ça, il considère que ta collection contient du `mixed`, et chaque accès à un élément perd son typage.
...
Si tu utilises [`phpstan/phpstan-symfony`](https://github.com/phpstan/phpstan-symfony), PHPStan vérifie que les templates [Twig](https://twig.symfony.com/) existent. Les fautes de frappe dans les noms de templates deviennent des erreurs.
...
- [Comment PHPStan peut améliorer la qualité de votre code PHP](/article/comment-phpstan-peut-vous-aider-a-ameliorer-la-qualite-de-votre-code-php), guide d'introduction à PHPStan
...
- [Documentation officielle PHPStan](https://phpstan.org/user-guide/getting-started), guide de démarrage
- [PHPStan rule levels](https://phpstan.org/user-guide/rule-levels), comprendre les niveaux d'analyse
- [Extension PHPStan pour Symfony](https://github.com/phpstan/phpstan-symfony), support natif Symfony
- [Extension PHPStan pour Doctrine](https://github.com/phpstan/phpstan-doctrine), typage des repositories et collections
