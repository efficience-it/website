...
C'est la méthode recommandée depuis Symfony 6.1. Elle élimine l'erreur PHPStan et rend ton code plus testable. Pour en savoir plus sur la configuration du [conteneur de services Symfony](https://symfony.com/doc/current/service_container.html), la documentation officielle détaille toutes les options d'injection.
