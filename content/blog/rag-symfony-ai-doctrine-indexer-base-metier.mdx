...
Si ton application tourne déjà sur PostgreSQL, c'est le choix le plus pragmatique. [pgvector](https://github.com/pgvector/pgvector) ajoute un type `vector` et des opérateurs de similarité directement dans ta base existante.
