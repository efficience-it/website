...
La réponse tient en trois lettres : **RAG** (Retrieval-Augmented Generation). Et depuis l'arrivée de [Symfony AI](https://symfony.com/blog/introducing-symfony-ai), on a enfin les briques pour le faire proprement dans l'écosystème Symfony.

Cet article te montre comment, concrètement, indexer ta base [Doctrine](https://www.doctrine-project.org/) dans un vector store et construire un pipeline RAG fonctionnel. Pas de théorie creuse. Du code, des choix d'architecture, des pièges à éviter.
...
- **Symfony 7** avec [Symfony AI](https://github.com/symfony/ai) pour l'orchestration
...
[Symfony AI](https://github.com/symfony/ai) fournit les abstractions nécessaires : modèles d'embedding, vector stores, chaînes de traitement.
...
Si tu as besoin de performances poussées sur de gros volumes ou de fonctionnalités avancées (filtrage par payload, sharding), [Qdrant](https://qdrant.tech/) est un excellent choix. C'est un vector store dédié, conçu spécifiquement pour la recherche de similarité.
...
On passe par [Symfony Messenger](https://symfony.com/doc/current/messenger.html) pour ne pas bloquer la requête HTTP. L'embedding est calculé de façon asynchrone.
...
L'écosystème [Symfony AI](https://github.com/symfony/ai) est encore jeune mais progresse vite. Combiné avec la maturité de [Doctrine](https://www.doctrine-project.org/) et la richesse de l'écosystème Symfony (Messenger, Security, Cache), tu as tout ce qu'il faut pour construire des applications IA robustes en PHP.
...
- [Symfony AI dans un projet legacy](/article/symfony-ai-projet-legacy-retour-experience) — retour d'expérience complet
...
- [Symfony AI sur GitHub](https://github.com/symfony/ai) — code source du composant
- [Doctrine ORM](https://www.doctrine-project.org/) — documentation officielle
- [OpenAI Embeddings Guide](https://platform.openai.com/docs/guides/embeddings) — comprendre les embeddings pour le RAG
