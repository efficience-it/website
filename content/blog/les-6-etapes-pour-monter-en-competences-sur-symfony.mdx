...
category: "Formation"
excerpt: "Symfony est un framework PHP populaire pour le développement web. Pour devenir expert, vous devez maîtriser les composants clés du framework."
...
- [Monter en compétence sur Claude Code](/article/monter-en-competence-claude-code), utiliser l'IA comme accélérateur d'apprentissage
