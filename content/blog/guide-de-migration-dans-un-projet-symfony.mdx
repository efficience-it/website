...
faq:
  - question: "Combien de temps prend une migration Symfony ?"
    answer: "Ca depend de la taille du projet et du nombre de versions a sauter. Une migration d'une version mineure (ex: 6.3 vers 6.4) prend quelques jours. Une migration majeure (ex: 4.4 vers 6.4) peut prendre plusieurs semaines. L'utilisation de Rector et PHPStan automatise 60 a 80% des changements et reduit considerablement le temps necessaire."
  - question: "Peut-on migrer Symfony sans interruption de service ?"
    answer: "Oui, c'est l'approche que nous recommandons. En travaillant branche par branche et en resolvant les deprecations progressivement, vous pouvez continuer a livrer des fonctionnalites pendant la migration. Les tests automatises garantissent qu'aucune regression n'est introduite."
  - question: "Que risque-t-on a rester sur une version Symfony non supportee ?"
    answer: "Les versions en fin de vie ne recoivent plus de correctifs de securite. Votre application devient vulnerable aux failles connues (CVE). De plus, les nouvelles versions de PHP et des bundles tiers cessent de supporter les anciennes versions de Symfony, ce qui cree un effet domino sur tout l'ecosysteme."
---
