...
- [PHPStan : améliorer la qualité du code PHP](/article/comment-phpstan-peut-vous-aider-a-ameliorer-la-qualite-de-votre-code-php), détecter les erreurs statiques avant de migrer
