...
C'est le cas d'usage le plus immédiat pour un développeur Symfony. Ton application tourne sur MySQL ou PostgreSQL via [Doctrine](/article/doctrine-orm-3-0-une-nouvelle-version-majeure-pour-les-bases-de-donnees). Avec un serveur MCP, Claude Code peut interroger cette base directement.
