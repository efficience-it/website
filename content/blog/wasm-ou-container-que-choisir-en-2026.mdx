...
Le container gagne aussi sur les processus longs. Un worker Symfony Messenger qui traite des messages pendant des heures, un job de calcul batch, un serveur Node.js avec connexions persistantes : tous bénéficient d'un environnement chargé une fois pour toutes. Le cold start est amorti, l'OS sous-jacent rend service, et la portabilité WASI n'apporte rien de visible.
