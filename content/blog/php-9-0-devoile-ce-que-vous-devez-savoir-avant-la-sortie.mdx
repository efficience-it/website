...
image: "/images/blog/cover-php-9.webp"
---
...
Les [dépréciations votées en PHP 8.5](https://wiki.php.net/rfc/deprecations_php_8_5) seront supprimées en PHP 9.0, comme celles votées en PHP 8.4 avant elles. Les projets encore sur une version non supportée cumulent ce chantier avec un risque de sécurité immédiat, que nous traitons dans notre [plan d'action fin de support Symfony et PHP](/article/symfony-php-fin-de-support-eol-plan-action).
...
- [Code source de PHP (php-src)](https://github.com/php/php-src)
