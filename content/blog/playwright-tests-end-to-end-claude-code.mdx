...
- [Tests d'API avec Newman dans GitLab CI](/article/comment-executer-des-tests-postman-avec-newman-dans-gitlab-ci), tester vos API en complément des tests E2E
