...
- [Audit web chez Efficience IT : méthode, critères et contenu](/article/comment-se-passe-un-audit-chez-efficience-it-quel-contenu-comment-procede-t-on-quels-sont-les-criteres-quel-procede), quantifier et prioriser la dette technique grâce à un audit structuré
