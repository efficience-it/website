...
- [PHPStan : améliorer la qualité du code PHP](/article/comment-phpstan-peut-vous-aider-a-ameliorer-la-qualite-de-votre-code-php), compléter Symfony Insight avec l'analyse statique PHPStan
