---
title: "Symfony Insight : à quoi ça sert"
date: "2023-01-31"
...
image: "/images/blog/cover-symfony-insight.webp"
...
**PHPStan** excelle dans l'analyse statique de types. Son système de niveaux (0 à 10) permet une adoption progressive, et ses extensions spécifiques Symfony et Doctrine détectent des incohérences fines dans le graphe de types. En revanche, PHPStan ne sait rien du comportement runtime de l'application.
