...
Le composant Runtime, introduit dans Symfony 5.3, est une évolution architecturale fondamentale souvent sous-estimée. Il découple l'application de son environnement d'exécution. Le même code peut tourner derrière Apache/mod_php, PHP-FPM, un serveur Swoole, [FrankenPHP](/article/concretement-cest-quoi-frankenphp) ou même en mode CLI, sans modification.
