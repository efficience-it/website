...
image: "/images/blog/domain-symfony.png"
---
...
Le dispatcher Symfony accepte n'importe quel objet depuis Symfony 5. Ton événement domaine n'a même pas besoin d'hériter de `Event`. L'adaptateur est presque trivial. Pour structurer proprement le dispatch de commands, queries et events, regarde comment utiliser [Symfony Messenger comme colonne vertébrale d'une archi hexagonale](/article/symfony-messenger-colonne-vertebrale-archi-hexagonale).
