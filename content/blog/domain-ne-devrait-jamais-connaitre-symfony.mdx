...
La discipline humaine ne suffit pas. Sur un projet avec dix développeurs, quelqu'un finira par ajouter un `use Doctrine\*` dans le domaine. [Deptrac](https://qossmic.github.io/deptrac/) automatise la vérification.
