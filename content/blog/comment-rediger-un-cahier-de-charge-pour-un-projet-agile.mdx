...
- [Quelle architecture choisir pour votre projet web ?](/article/quelle-architecture-de-projet-choisir-entre-micro-service-ou-monolithe-modulaire), comprendre les choix structurants à anticiper avant de démarrer
- [Comment se passe un audit chez Efficience IT ?](/article/comment-se-passe-un-audit-chez-efficience-it-quel-contenu-comment-procede-t-on-quels-sont-les-criteres-quel-procede), évaluer l'état d'un projet existant avant de rédiger un nouveau cahier des charges
