...
- [Comment se passe un audit chez Efficience IT ?](/article/comment-se-passe-un-audit-chez-efficience-it-quel-contenu-comment-procede-t-on-quels-sont-les-criteres-quel-procede), Evaluer l'état d'un projet existant avant de rédiger un nouveau cahier des charges
