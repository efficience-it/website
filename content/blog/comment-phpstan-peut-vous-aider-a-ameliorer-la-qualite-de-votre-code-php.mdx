...
Avec ce fichier en place, un simple `./vendor/bin/phpstan analyse` suffit. Consultez la [référence de configuration](https://phpstan.org/config-reference) pour la liste complète des options.

## Les niveaux de règles : une adoption progressive

PHPStan propose 10 [niveaux de règles](https://phpstan.org/user-guide/rule-levels), de 0 à 9. Chaque niveau inclut les vérifications du précédent.
