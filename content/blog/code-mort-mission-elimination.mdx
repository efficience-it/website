...
image: "/images/blog/cover-code-mort.webp"
...
- **Refactorisation** : de nouvelles implémentations peuvent rendre certaines parties du code ancien inutiles. Des outils comme [Rector](/article/rector-et-ses-pouvoirs-maitrisez-levolution-de-votre-code-symfony) automatisent ces transformations et aident à identifier le code devenu superflu. Côté JavaScript, [TypeScript](/developpement-typescript) repère lui aussi le code inatteignable grâce à son analyse de types.
...
Le code mort peut contenir des vulnérabilités qui ne sont pas immédiatement apparentes. Comme il n'est pas utilisé, ces [failles CVE](/article/cve-comprendre-les-failles-pour-mieux-se-proteger) peuvent passer inaperçues et rester non corrigées, posant un risque pour la sécurité de l'application.
...
En adoptant cette extension, on fait un pas de plus vers un code PHP plus propre, plus efficace et plus facile à maintenir. L'élimination du code mort s'inscrit dans une démarche continue d'amélioration de la qualité et de la performance des projets PHP. C'est aussi une étape indispensable dans un parcours de [modernisation applicative](/modernisation-applicative) pour [reprendre un projet en main](/reprise-projet-symfony) et reconstruire la confiance de l'équipe dans la codebase. Pour identifier l'ensemble des axes d'amélioration de votre codebase, notre [diagnostic PHP](/audit-code-php) couvre le code mort, la dette technique et la conformité aux standards.
