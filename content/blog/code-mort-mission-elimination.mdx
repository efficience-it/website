...
- [Comment PHPStan peut améliorer la qualité de votre code PHP](/article/comment-phpstan-peut-vous-aider-a-ameliorer-la-qualite-de-votre-code-php) — introduction à PHPStan
...
- [La dette technique : faut-il vraiment en avoir peur ?](/article/la-dette-technique-faut-il-vraiment-en-avoir-peur) — comprendre l'accumulation de dette
...
- [PHPStan — guide de démarrage](https://phpstan.org/user-guide/getting-started) — installer et configurer PHPStan
- [Rector sur GitHub](https://github.com/rectorphp/rector) — automatiser le nettoyage de code
- [PHP The Right Way — Code Style](https://phptherightway.com/#code_style_guide) — bonnes pratiques PHP
