...
- [DbToolsBundle : anonymiser vos bases de données](/article/dbtoolsbundle-anonymiser-vos-bases-de-donnees), protéger les données personnelles dans les environnements alimentés par des fixtures de production
- [Doctrine ORM 3.0 : une nouvelle version majeure](/article/doctrine-orm-3-0-une-nouvelle-version-majeure-pour-les-bases-de-donnees), comprendre les évolutions Doctrine qui impactent la gestion des entités dans vos fixtures
