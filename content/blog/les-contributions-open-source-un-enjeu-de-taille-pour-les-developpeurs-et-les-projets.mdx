...
La CI devient un outil central, comme nous le montrons dans notre article sur [l'exécution de tests Postman avec Newman dans GitLab CI](/article/comment-executer-des-tests-postman-avec-newman-dans-gitlab-ci). Une pipeline bien conçue protège le projet contre les régressions et libère les mainteneurs de la vérification manuelle. Tests unitaires, tests d'intégration, [analyse statique avec PHPStan](/article/comment-phpstan-peut-vous-aider-a-ameliorer-la-qualite-de-votre-code-php), vérification des coding standards, matrice de compatibilité entre versions de langage et de dépendances : chaque couche réduit la charge cognitive des reviewers et accélère le cycle de contribution.
...
Le choix d'une licence n'est pas une formalité administrative. Tout comme le respect des [PSR en PHP](/article/qu-est-ce-que-les-psrs-et-a-quoi-servent-ils), il conditionne la manière dont votre code peut être utilisé, modifié et redistribué. MIT, Apache 2.0, GPL, AGPL : chaque licence porte une vision différente de la propriété intellectuelle et de la réciprocité.
...
Pérenniser l'open source exige un engagement collectif. Les fondations jouent un rôle structurant en finançant des mainteneurs et en assurant la gouvernance de projets critiques. Dans l'écosystème PHP, [la Fondation PHP a soufflé ses trois bougies](/article/la-fondation-php-souffle-ses-trois-bougies) en devenant un pilier de cette gouvernance collective. Les programmes de sponsoring sur GitHub ou Open Collective permettent un soutien direct. Mais la contribution la plus précieuse reste le temps : des développeurs qualifiés qui consacrent régulièrement des heures à la revue de code, au triage des issues et à la maintenance des projets dont ils dépendent.
...
Que vous soyez développeur confirmé cherchant à élargir votre horizon technique, lead souhaitant structurer les pratiques de contribution de votre équipe, ou architecte évaluant l'open source comme levier stratégique, la démarche commence de la même manière : choisissez un projet, lisez son code, soumettez une première PR. Contribuer à Symfony suppose aussi une maîtrise solide du framework : les [6 étapes pour monter en compétences sur Symfony](/article/les-6-etapes-pour-monter-en-competences-sur-symfony) donnent un parcours structuré avant de se lancer.

Retrouvez nos contributions sur notre GitHub : [efficience-it](https://github.com/efficience-it).

## Pour aller plus loin

- [Core Team : structurer une équipe projet](/article/core-team-organisation-projet), comment le modèle Core Team organise la gouvernance des projets open source
- [Les certifications Symfony, Twig et Sylius](/article/les-certifications-symfony-twig-symfony-sylius), valoriser ses compétences open source par la certification
