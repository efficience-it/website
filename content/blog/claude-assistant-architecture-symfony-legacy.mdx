...
- [PHPStan au niveau max sur un projet Symfony](/article/phpstan-niveau-max-symfony-10-erreurs), valider l'architecture par analyse statique
- [Conventions de codage : bonnes pratiques pour un code maintenable](/article/coding-conventions), définir les règles que Claude doit respecter dans vos projets
