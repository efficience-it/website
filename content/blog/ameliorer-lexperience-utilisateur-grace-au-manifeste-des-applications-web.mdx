...
Cette stratégie d'enrichissement progressif s'étend au-delà du manifeste. Elle guide les choix d'architecture : une [API REST respectant les bonnes pratiques](/article/api-rest-les-bonnes-pratiques) sert aussi bien une PWA qu'une application native future, un Service Worker bien structuré prépare le terrain pour des fonctionnalités temps réel sans refonte. L'intégration du manifeste dans un projet Symfony s'inscrit naturellement dans une démarche de [développement web sur mesure](/developpement-web-sur-mesure) orientée performance.
