...
- [Utiliser Claude comme assistant d'architecture Symfony](/article/claude-assistant-architecture-symfony-legacy), configurer Claude Code pour un projet legacy
- [IA génératives : forces et faiblesses](/article/forces-et-faiblesses-des-ia-generatives-les-plus-utilisees), panorama des IA en entreprise
