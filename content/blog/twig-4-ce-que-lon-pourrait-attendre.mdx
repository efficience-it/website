...
Pour les architectes qui conçoivent des applications Symfony, Twig 4 confirmerait une tendance : le front-end Symfony n'est pas un front-end au rabais, mais un front-end opiniâtre, qui assume le serveur comme point de contrôle principal et traite le JavaScript comme un enrichissement progressif. Pour comprendre pourquoi cette approche s'inscrit dans la philosophie du framework, l'article [pourquoi choisir Symfony pour vos projets](/article/pourquoi-choisir-symfony-pour-vos-projets) en expose les fondements.
