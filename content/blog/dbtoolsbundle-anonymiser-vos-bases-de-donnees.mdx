...
- [Comprendre et utiliser le bundle Alice Faker dans vos projets Symfony](/article/comprendre-et-utiliser-le-bundle-alice-faker-dans-vos-projets-symfony), coupler l'anonymisation avec une stratégie de fixtures robuste pour les environnements de test
