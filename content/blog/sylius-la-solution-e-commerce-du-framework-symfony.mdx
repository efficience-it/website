...
faq:
  ...
  - question: "Quelles sont les differences entre Sylius et Prestashop ?"
    answer: "Sylius est construit sur Symfony et offre une architecture decouplees par composants, une API REST/GraphQL native et une testabilite complete. Prestashop est un CMS e-commerce plus accessible pour les debutants mais moins flexible pour les projets avec des regles metier complexes. Sylius est prefere quand la personnalisation prime sur la rapidite de mise en place."
