...
faq:
  - question: "Sylius est-il gratuit et open source ?"
    answer: "Oui, Sylius est entierement open source sous licence MIT. Le code est disponible sur GitHub et vous pouvez l'utiliser librement pour des projets commerciaux. Sylius propose aussi une offre Sylius Plus avec des fonctionnalites avancees (marketplace, multi-store) sous licence commerciale."
  - question: "Quelles sont les differences entre Sylius et Prestashop ?"
    answer: "Sylius est construit sur Symfony et offre une architecture decouplees par composants, une API REST native via API Platform et une testabilite complete. Prestashop est un CMS e-commerce plus accessible pour les debutants mais moins flexible pour les projets avec des regles metier complexes. Sylius est prefere quand la personnalisation prime sur la rapidite de mise en place."
  - question: "Peut-on utiliser Sylius pour du headless commerce ?"
    answer: "Oui, Sylius expose nativement une API complete via API Platform. Vous pouvez utiliser un front React, Next.js, Vue.js ou une application mobile tout en beneficiant du back-office Sylius pour la gestion du catalogue, des commandes et des promotions."
---
