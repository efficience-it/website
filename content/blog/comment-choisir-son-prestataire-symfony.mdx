...
image: "/images/blog/cover-choisir-prestataire-symfony.webp"
faq:
...
En tant qu'[agence Symfony spécialisée](/agence-symfony-france) depuis plus de dix ans, nous avons souvent été appelés pour [reprendre des projets](/reprise-projet-symfony) laissés par des prestataires inadaptés. Voici les critères qui comptent vraiment. Si vous reprenez une application déjà construite, notre [checklist de due diligence technique](/article/due-diligence-technique-application-symfony-checklist-repreneur) complète cette grille.
