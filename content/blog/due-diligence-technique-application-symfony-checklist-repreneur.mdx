...
L'audit examine ensuite la documentation technique (architecture, décisions, runbooks), la connaissance distribuée dans l'équipe (qui sait quoi, qui peut faire quoi) et la culture d'ingénierie (revue de code, [conventions de codage](/article/coding-conventions) partagées, ownership). Une équipe sans revue de code systématique accumule mécaniquement de la dette. Notre offre de [reprise de projets Symfony](/reprise-projet-symfony) intègre cette dimension dès le premier diagnostic.
