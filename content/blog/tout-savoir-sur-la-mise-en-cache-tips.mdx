...
image: "/images/blog/cover-mise-en-cache.webp"
...
- Pourquoi Docker est indispensable en production, déployer des caches et des CDN avec Docker
...
- Déployer NuxtJS avec GitLab CI, S3 et CloudFront, mettre en place un CDN pour vos assets front-end
