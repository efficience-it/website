...
La **maintenance applicative**, ou TMA, est présente pour accompagner le cycle de vie d'un projet, depuis la correction de petits bugs jusqu'à la création de nouvelles fonctionnalités ou la mise à niveau de composants pour suivre les évolutions technologiques. Notre offre de [maintenance applicative Symfony](/maintenance-applicative-symfony) formalise cet accompagnement avec des engagements concrets adaptés à chaque projet.
...
- Adaptation de l'interface aux nouvelles exigences d'accessibilité ([normes RGAA](/article/normes-rgaa-les-cles-dune-experience-utilisateur-reussie-pour-tous), WCAG)
...
- Nettoyer le [code mort](/article/code-mort-mission-elimination) et le code obsolète
