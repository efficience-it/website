---
title: "Symfony et PHP en fin de support : risques, impacts et plan d'action"
date: "2026-05-13"
updatedAt: "2026-05-13"
author: "Louis-Arnaud Catoire"
category: "Symfony"
excerpt: "Calendrier actualisé des fins de support Symfony et PHP, conséquences concrètes (CVE, assurance cyber, NIS2, RGPD), méthode pour évaluer son exposition et trois stratégies de sortie selon la criticité de l'application."
...
| Symfony 5.4 LTS | EOL | nov 2023 | nov 2024 |
| Symfony 6.4 LTS | Support actif | nov 2026 | nov 2027 |
| Symfony 7.0 | EOL | janv 2024 | juil 2024 |
| Symfony 7.1 | EOL | juil 2024 | janv 2025 |
| Symfony 7.2 | EOL | janv 2025 | juil 2025 |
| Symfony 7.3 | Sécurité seulement | janv 2026 | juil 2026 |
| Symfony 7.4 LTS | Support actif | nov 2027 | nov 2028 |
...
| PHP 8.3 | Support actif | déc 2025 | déc 2027 |
| PHP 8.4 | Support actif | déc 2026 | déc 2028 |

Lecture pratique. Toute application encore exécutée sur Symfony 4.4, 5.4, 7.0, 7.1 ou 7.2 est en exposition active : aucune CVE publiée depuis l'EOL n'est patchée. Idem sur PHP 7.4, 8.0 ou 8.1. Les versions Symfony 6.4 LTS et 7.4 LTS sont les deux cibles raisonnables pour les douze prochains mois. Sur PHP, 8.3 ou 8.4 est le standard de marché en 2026.
...
Phase 1, semaines 1 à 4 : audit préalable. Cartographie des dépendances Composer, identification des dépendances abandonnées, mesure de la couverture de tests, analyse statique au niveau maximum supporté. Notre [audit de code PHP](/audit-code-php) cadre cette phase.
...
Si vous suspectez une exposition active sur votre application, prenez 30 minutes pour un premier diagnostic avec un expert. Le [pré-audit Symfony gratuit](/audit-symfony-gratuit) permet d'objectiver l'exposition, d'identifier les blocages techniques à la migration et de proposer un séquencement adapté à la taille de votre équipe.
