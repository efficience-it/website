...
- Le blog de [Matthias Noback](https://matthiasnoback.nl/tags/command%20bus/) sur le Command Bus, qui a largement influencé l'écosystème PHP sur ces patterns
...
- [Matthias Noback — blog sur le Command Bus](https://matthiasnoback.nl/tags/command%20bus/) — articles de référence sur le pattern
